	...
	<div id="container_room">
		...
		<div class="roomList">
			<table class="table">
				...
				<tr>
					<td id="select"><a href="RoomInfo?roomseq=2">스위트 <button id="next">&#10095;</button></a></td>
				</tr>
				<tr>
		...
		<div class="wrap">
  <button class="button" onclick="location.href='RsRoomInput?roomseq=<%=roomvo.getRoomseq()%>'"> <%=roomvo.getRoomname()%>룸 예약</button>
</div>
		</div>
		...
		<div class="infoWrap">
					...
					<div class="slideWrap">
						<ul class="slideList">
							<li><a> <label for="slide03" class="left"></label> <img
									src="./img/room3-1.jpg"> <label for="slide02"
									class="right"></label>
							</a></li>
							<li><a> <label for="slide01" class="left"> </label> <img
									src="./img/room3-2.jpg"> <label for="slide03"
									class="right"></label>
							</a></li>
							<li><a> <label for="slide02" class="left"> </label> <img
									src="./img/room3-3.jpg"> <label for="slide01"
									class="right"></label>
							</a></li>
						</ul>
					</div>
			...
			<div class="roomInfo">
				...
				<div id="roomContent">
					<h1 style="color: #6e583e; font-size: 2.0em;">스위트 룸</h1>
					<br /> 스위트 룸은 편안한 침실과 <br /> 안락한 거실이 있어 품격 있는 휴식을 제공합니다.
				</div>
