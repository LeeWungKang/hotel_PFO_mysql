		...
		<div class="container">
			<form action="" name="Join_form" method="post">
				<div class="form_txtInput">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="id" name="id"
										placeholder="영문자+숫자만 입력 가능"> <input type="hidden"
										name="ID_Duplication" value="ID_Uncheck"> <font
										id="msg" style="font-size: 0.8em;"> &nbsp; <!--중복확인 문구 --></font></td>
								</tr>
								<tr>
									<th><span>이름</span></th>
								...
								<tr>
									...
									<td><input type="password" name="pw2" id="pw2"
										placeholder="비밀번호를 확인하세요"> <font id="check"
										style="font-size: 0.8em;"> &nbsp; <!--비밀번호 체크 문구  --></font></td>
								</tr>
								<tr>
									...
									</select> <input type="text" class="telLength" name="tel_1"
										maxlength="4"
										onkeyup="moveNext(this,4,document.Join_form.tel_2)"> <span
										class="mar10"> - </span> <input type="text" class="telLength"
										name="tel_2" maxlength="4"
										onkeyup="moveNext(this,4,document.Join_form.email)"></td>
								</tr>
								<tr class="email">
									<th><span>이메일</span></th>
									<td><input type="hidden" name="Email_Duplication"
										value="Email_Uncheck"> <input type="text"
										class="email" placeholder="이메일 입력" name="email" id="email">
										<span class="mar10">@</span> <input type="text"
										class="email email2" placeholder="직접입력" name="email02"
										id="email02" value=""> <select name="email_value"
										id="email_value" class="email_value">
									...
									<br> <font id="emailCheck" style="font-size: 0.8em;">
											&nbsp;&nbsp; <!--이메일 체크 문구  -->
									</font></td>
								</tr>
							</tbody>
					...
					<div class="btn_wrap">
						<input type="submit" onclick="Check_value(); return false;"
							value="회원가입" class="submitBtn">
					</div>
				</div>
				<!-- form_txtInput E -->
			</form>
