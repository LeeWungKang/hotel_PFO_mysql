...
@WebServlet("/Get_Board_Modify")
public class Get_Board_Modify extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	}
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	System.out.println("-------------------/Get_Board_Modify");
		...
		try {
			...
			String sql = "select * from HomeBoard where seq=?";
			...
			RequestDispatcher dis = request.getRequestDispatcher("index.jsp?filePath=./boardJSP/modifyBoard");
